...
public class Library {
    ...
    public ArrayList<String> func1() {
        ...
        result.add(plataforma.greet("game3"));
        result.add(plataformaConsumer1.greet("game3"));
        result.add(libDep1.greet("game3"));
        return result;
    }
    public ArrayList<String> func2() {
        ...
        ArrayList<String> result = new ArrayList<>();
        result.add(plataforma.greet("game3"));
        result.add(plataforma.greet1("game3"));
        result.add(plataforma.greet2("game3"));
        result.add(plataformaConsumer1.greet("game3"));
        result.add(libDep1.greet("game3"));
        return result;
    }
    public String unused1(String name) {
        return "unused1 from game3, " + name;
    }
    public String unused2(String name) {
        return "unused2 from game3, " + name;
    }
    public String unused3(String name) {
        return "unused3 from game3, " + name;
    }
    public String unused4(String name) {
        return "unused5 from game3, " + name;
    }
    public String unused5(String name) {
        return "unused5 from game3, " + name;
    }
    public String unused6(String name) {
        return "unused6 from game3, " + name;
    }
    public String unused7(String name) {
        return "unused7 from game3, " + name;
    }
    public String unused8(String name) {
        return "unused8 from game3, " + name;
    }    
    public String unused9(String name) {
        return "unused9 from game3, " + name;
    }
}